...
{
    public partial class mig_world_cities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAfterDinner", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FirstPlaceForRoute", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTransportVehicleExist = table.Column<bool>(type: "boolean", nullable: true),
                    BreakfastId = table.Column<Guid>(type: "uuid", nullable: true),
                    LunchId = table.Column<Guid>(type: "uuid", nullable: true),
                    DinnerId = table.Column<Guid>(type: "uuid", nullable: true),
                    FirstPlaceForRouteId = table.Column<Guid>(type: "uuid", nullable: true),
                    SecondPlaceForRouteId = table.Column<Guid>(type: "uuid", nullable: true),
                    ThirdPlaceForRouteId = table.Column<Guid>(type: "uuid", nullable: true),
                    EventAfterDinnerId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_BreakfastId",
                table: "TravelRoutes",
                column: "BreakfastId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_DinnerId",
                table: "TravelRoutes",
                column: "DinnerId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_EventAfterDinnerId",
                table: "TravelRoutes",
                column: "EventAfterDinnerId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_FirstPlaceForRouteId",
                table: "TravelRoutes",
                column: "FirstPlaceForRouteId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_LunchId",
                table: "TravelRoutes",
                column: "LunchId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_SecondPlaceForRouteId",
                table: "TravelRoutes",
                column: "SecondPlaceForRouteId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelRoutes_ThirdPlaceForRouteId",
                table: "TravelRoutes",
